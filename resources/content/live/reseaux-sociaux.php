...
return [
    ...
    'questions' => [
        ...
        [
            'type' => 'choice',
            'prompt' => "Laquelle de ces deux photos correspond le mieux aux standards de beauté actuels ?",
            'options' => [
                'La photo de gauche',
                'La photo de droite',
                'Les deux',
            ...
            'notes' => "Cas 1, étape 1. Les deux photos côte à côte : gauche le portrait lissé, droite le visage âgé qui rit. Une minute, afficher. AUCUN COMMENTAIRE : on passe directement à Q3.",
        ],
        [
            'type' => 'choice',
            'prompt' => "Maintenant, laquelle trouves-tu la plus belle ?",
            'options' => [
                'La photo de gauche',
                'La photo de droite',
                'Les deux',
            ...
            'notes' => "Cas 1, étape 2. Une minute, afficher à côté de Q2. AUCUN COMMENTAIRE, pas même « est-ce la même réponse ». On passe directement à Q4.",
        ],
        [
            'type' => 'words',
            'prompt' => "Qu'est-ce qui fait sa beauté ? Un mot.",
            'notes' => "Cas 1, étape 3. Une minute, afficher et LAISSER À L'ÉCRAN. C'est SEULEMENT MAINTENANT qu'on commente.\n\nRemettre les deux votes côte à côte. Si les réponses divergent : « Vous venez de distinguer deux choses que le feed confond : correspondre aux standards et être perçu comme beau. » Si elles convergent : « Et pourtant regardez les mots que vous avez choisis pour dire ce qui fait sa beauté : aucun n'est un standard. » Lire les gros mots (vivant, vrai, joie, présence / symétrie, lisse, parfait).\n\nPuis 1 Samuel 16,7 en entier, et ce que le texte NE dit PAS : le corps compte, l'apparence ne suffit pas. « Le cœur est le centre, mais le corps peut en devenir le langage. »",
        ],
        [
            'type' => 'words',
